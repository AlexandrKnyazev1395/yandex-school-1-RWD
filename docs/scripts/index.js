...
class CardsFactory {
  ...
  createCardElement() {
    ...
    if (size === 's') {
      return new cardsConstructors.SmallCardElement(this.elementInfo);
    }
    else if (size === 'm') {
      return new cardsConstructors.MeiumCardElement(this.elementInfo);
    }
    else if (size === 'l') {
      return new cardsConstructors.LargeCardElement(this.elementInfo)
    }
  }
}
